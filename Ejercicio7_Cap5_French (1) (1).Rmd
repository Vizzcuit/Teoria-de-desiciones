...
ggplot()+
  geom_function(fun=u, 
                linewidth=1.2, color="orange", xlim=c(-2999, 1000))+
  theme_bw()
```
...
```{r}
r <- function(x){-fderiv(u,x,n=2, method="central")/fderiv(u,x,n=1,  
                                                           method="central")}



ggplot()+
  geom_function(fun=r, xlim=c(-2999, 1000)
                , color="orange")+
  geom_function(fun=function(x)1/(x+3000), xlim=c
                (-2999, 1000), color="green")+
  theme_bw()
```
